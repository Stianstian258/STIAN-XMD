...
zokou({
  ...
  try {
    ...
    if (_0x1e97ca && _0x1e97ca.length > 0) {
      ...
      const _0x39f848 = await fetch("https://apis.davidcyriltech.my.id/download/ytmp4?url=" + encodeURIComponent(_0x46850e) + "&apikey=" + "gifted");
